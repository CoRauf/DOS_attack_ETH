...
/*
    ...
    Here the issue. Once a user is detroned, he gets sent his ETHer right away in the same function call, which could lead to the contract falling prey to a REVERT_BASED_DOS attack. Denying all other users from taking the throne even if they sent triple the amount of the current king;
 */
